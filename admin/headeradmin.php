...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php">Find Food Toba</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseComponents" data-parent="#exampleAccordion">
            ...
            <span class="nav-linkfa-list-alt-text">Tempat Makan</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
                <a href="sarankanTempatMakan.php">Tambah</a>
            </li>
            <li>
                <a href="table.php">Daftar</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            <li>
                <a href="formMenuAdmin.php">Tambah</a>
            </li>
            <li>
                <a href="tampil_semuaMenu.php">Daftar</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="ExamplePages2">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages2">
            <li>
                <a href="tableArtikel.php">Daftar</a>
            </li>
          </ul>
        </li>
      </ul>
